...
public class TodayAppointmentActivity extends AppCompatActivity {
    ...
    private ActivityTodayAppointmentBinding activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activity = DataBindingUtil.setContentView(this, R.layout.activity_today_appointment);
            ...
            call.enqueue(new Callback<ResultOfApi>() {
                ...
                public void onResponse(@NonNull Call<ResultOfApi> call, @NonNull retrofit2.Response<ResultOfApi> response) {
                    ...
                    if (jsonResponse.getSuccess().equalsIgnoreCase("Success") &&
                        ...
                        Toast.makeText(TodayAppointmentActivity.this, "Deleted Successfully", Toast.LENGTH_SHORT).show();

                    } else {
                        Toast.makeText(TodayAppointmentActivity.this, "Profile Update Error", Toast.LENGTH_SHORT).show();
    ...
    public void AllGetAppointment() {
        ...
        if (Utils.isConnectingToInternet(this)) {
            ...
            Call<ResultOfSuccess> call = request.getAppointmentList(manager.getPreferences(TodayAppointmentActivity.this, "doctor_id"),"","");
            ...
            call.enqueue(new Callback<ResultOfSuccess>() {
                ...
                public void onResponse(@NonNull Call<ResultOfSuccess> call, @NonNull retrofit2.Response<ResultOfSuccess> response) {
                    ...
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        try {
                            Toast.makeText(TodayAppointmentActivity.this, "" + response.errorBody().string(), Toast.LENGTH_SHORT).show();
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
