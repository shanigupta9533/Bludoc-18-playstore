...
public class PharmacistAdapter  extends RecyclerView.Adapter<PharmacistAdapter.viewHolder> implements Filterable {
    ...
    // Create new views
    @Override
    public PharmacistAdapter.viewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
    ...
    @Override
    public void onBindViewHolder(PharmacistAdapter.viewHolder viewHolder, final int position) {
