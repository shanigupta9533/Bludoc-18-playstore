...
public class Pres_LabTest_adapter extends RecyclerView.Adapter<Pres_LabTest_adapter.ViewHolder> {
    Context context;
    ...
    public Pres_LabTest_adapter(ArrayList<LabTestItem> medicines, Context context) {
