...
public class MyTemplates  extends Fragment {
    ...
    static TemplateAdapter templateAdapter;
    static ArrayList<TemplatesItem> templatesItemArrayList = new ArrayList<>();
    ...
    private void initViewsnCalls(View view) {
        ...
        Glide.with(mContext)
                .load(R.drawable.medicine___)
                .apply(new RequestOptions()
                        .diskCacheStrategy(DiskCacheStrategy.ALL))
                .into(iv_no_template);

        tv_no_template.setText(getResources().getString(R.string.create_prescribed_medicines));
    ...
    public void initViewHolder() {
        ...
        apiViewHolder.getTemplates(manager.getPreferences(mContext, "doctor_id"))
    ...
    private SingleObserver<ResponseNewMyTemplates> responseTemplates = new SingleObserver<ResponseNewMyTemplates>() {
        @Override
        ...
        @Override
        public void onSuccess(ResponseNewMyTemplates response) {
            if (response != null) {
                ...
                } else if (response.getMessage().equals("templates")) {
                    templatesItemArrayList = new ArrayList<>();
                    templatesItemArrayList = response.getTemplates();
                    Collections.reverse(templatesItemArrayList);
                    templateAdapter = new TemplateAdapter(templatesItemArrayList, TemplateSelection.patient_id,TemplateSelection.definer,mContext,mBag,apiViewHolder, fl_progress_bar);
